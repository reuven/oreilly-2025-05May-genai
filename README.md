# Notes and programs from "Co-Programming in Python with GenAI"

This repo contains the Jupyter notebook from this class with O'Reilly in May 2025.  It'll remain open, so you can review the material later on.
